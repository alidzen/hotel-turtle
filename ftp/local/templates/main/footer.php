		...
		<div class="l-limit-wrap">
			<div class="l-footer__row">
				<div class="l-footer__col">
					<div class="b-olympia">
						<div class="b-olympia__txt">
							<? $APPLICATION->IncludeFile('/local/area/'.LANGUAGE_ID.'/madeby.php', Array(), Array('MODE' => 'text')); ?>
						</div>
						<a href="http://www.olympia.digital/" target="_blank" title="Олимпия"
						   class="b-olympia__logo-wrap">
							<svg xmlns="http://www.w3.org/2000/svg" viewbox="0 103.8 1280 634.3"
								 class="b-olympia__logo">
								<g fill="#FFF">
									<path
				...
				<div class="l-footer__col">
					<div class="b-menu-contacts b-menu-contacts_theme_footer">
									<?$APPLICATION->IncludeFile('/local/area/'.LANGUAGE_ID.'/phone-block.php', Array(), Array('MODE' => 'html')
									);?>
						<a href="#popup-map-common" class="b-menu-contacts__map j-map-popup">
							<? $APPLICATION->IncludeFile('/local/area/'.LANGUAGE_ID.'/address-2.php', Array(), Array('MODE' => 'html')); ?>
						</a>
					</div>
							</div>
				<div class="l-footer__col">
...
<? $APPLICATION->IncludeFile("/local/area/counters.php", Array(), Array("MODE" => "text", "NAME" => "счетчики")); ?>
</body>
</html>

<?php

$seoObject = CIBlockElement::GetList(["NAME" => "ASC"], ["IBLOCK_ID" => 8, "ACTIVE" => "Y", "=NAME" => $APPLICATION->GetCurDir(), "PROPERTY_LANGUAGE_ID_VALUE" => mb_strtoupper(LANGUAGE_ID)], false, ["nTopCount" => 1], ["ID", "IBLOCK_ID"])->Fetch();

if (isset($seoObject['ID']))
{
	$ipropValues = new \Bitrix\Iblock\InheritedProperty\ElementValues($seoObject['IBLOCK_ID'], $seoObject['ID']);
	$seoValues = $ipropValues->getValues();

	if ($seoValues["ELEMENT_PAGE_TITLE"] != "")
		$APPLICATION->SetTitle($seoValues["ELEMENT_PAGE_TITLE"]);

	$browserTitle = \Bitrix\Main\Type\Collection::firstNotEmpty([], '', $seoValues, "ELEMENT_META_TITLE");
	...
	$metaKeywords = \Bitrix\Main\Type\Collection::firstNotEmpty([], '', $seoValues, "ELEMENT_META_KEYWORDS");
	...
	$metaDescription = \Bitrix\Main\Type\Collection::firstNotEmpty([], '', $seoValues, "ELEMENT_META_DESCRIPTION");
