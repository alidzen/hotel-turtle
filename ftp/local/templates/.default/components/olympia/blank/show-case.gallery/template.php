<?if($arResult['ITEMS'] !== NULL):?>
	<div
		class="<?=(isset($arParams['CLASS_LIST']) ? $arParams['CLASS_LIST'] : 'b-gallery j-gallery j-gallery_theme_mobile j-gallery_theme_tablet');?>">
		<div data-height="100%" data-minwidth="100%"
