										...
										<? else: ?>
											<? if ($arItem['PROPERTIES']['PRICE_FROM']['VALUE'] != ''): ?>
												<? if ($arItem['PROPERTIES']['PRICE_TO']['VALUE'] != ''): ?>
													<span class="b-room__time"><?=GetMessage('FROM');?></span>&nbsp;
													<span
												...
												<?=$arItem['PROPERTIES']['PRICE_FROM']['VALUE'];?><span class="b-ruble">g</span>
														<? if ($arItem['PROPERTIES']['OLD_PRICE']['VALUE'] != ''): ?>
															<span class="b-room__old-price"><?=$arItem['PROPERTIES']['OLD_PRICE']['VALUE'];?>
																<span class="b-ruble">g</span></span>
														<? endif; ?>
											</span>
													<? if ($arItem['PROPERTIES']['FOR']['VALUE'] != ''): ?>
									...
									<div class="l-action__border">
										<div class="l-action__cnt">
											<div class="l-action__ttl">
												<h2 class="f-callback-note b-bottom-dash-pos-left has_margin-small">
													<?=$arItem['FIELDS']['NAME'];?>
													<span class="b-price">
												<? if ($arItem['PROPERTIES']['PRICE_FROM']['VALUE'] != ''): ?>
													<? if ($arItem['PROPERTIES']['PRICE_TO']['VALUE'] != ''): ?>
														<?=GetMessage(
															'FROM'
														);?> <?=$arItem['PROPERTIES']['PRICE_FROM']['VALUE'];?>
														<span
															class="b-ruble">g</span>
												<?=GetMessage(
															'TO'
														);?> <?=$arItem['PROPERTIES']['PRICE_TO']['VALUE'];?>
														<span
															class="b-ruble">g</span>
													<? else: ?>
														<?=$arItem['PROPERTIES']['PRICE_FROM']['VALUE'];?>
												...
												<div class="l-room-item__descr">
													<div class="l-room-item__params">
														<? if ($arItem['PROPERTIES']['R_SIZE']['VALUE'] != ''): ?>
															<div class="b-room-param"><?=GetMessage('ROOM_SIZE_TEXT');?>
																: 
																<span class="b-room-param__data"><?=$arItem['PROPERTIES']['R_SIZE']['VALUE'];?>
																	 м<sup>2</sup></span>
															</div>
														<? endif; ?>
													...
													<div class="l-room-item__feature">
														<ul class="b-room-list">
															<li class="b-room-list__item">
																...
																<div class="b-room-list__item-txt"><?=GetMessage(
																		'MANSARDA'
																	);?></div>
															</li>
															<li class="b-room-list__item">
													...
													<div class="l-room-item__btn">
														<a href="#" class="b-btn b-btn_width_auto">
															<? $APPLICATION->IncludeFile('/local/area/'.LANGUAGE_ID.'/global-booking-btn.php', [], ['MODE' => 'text'] ); ?>
														</a>
													</div>
												</div>
											</div>
