	...
	<div style="background-image: url('<?=$arResult['DETAIL_PICTURE']['SRC']?>');" class="b-cafe-gallery">
		<div class="b-cafe-gallery__border">
			<div class="b-cafe-gallery__cnt">
				<h2 class="b-cafe-gallery__ttl"><?=$arResult['NAME'];?> <br><?=$arResult['PROPERTIES']['SUB_NAME']['VALUE'];?></h2>
				<div class="b-cafe-gallery__txt"><?=$arResult['PROPERTIES']['HEADER_TXT']['VALUE']['TEXT'];?>
				</div>
			</div>
		</div>
	</div>
