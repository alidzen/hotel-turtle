...
$APPLICATION->SetPageProperty("description", "Команда отеля “Ахиллес и Черепаха” разрабатывает специальные предложения для особых случаев, чтобы ваше путешествие или важное событие прошло идеально");
